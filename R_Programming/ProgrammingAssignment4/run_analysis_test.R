...
run_analysis_test <- function(){
        ...
        if(file.exists("C:/Users/sec/Desktop/Coursera/allData.csv") &
           file.exists("C:/Users/sec/Desktop/Coursera/tidyDataMeans.txt")){
                stop("Files already exist: allData.csv, tidyDataMeans.txt")
        }
        ...
        if(!file.exists("C:/Users/sec/Desktop/Coursera/allData.csv")){
                write.csv(allData, file = "C:/Users/sec/Desktop/Coursera/allData.csv", row.names = FALSE)
        }
        ...
        if(!file.exists("C:/Users/sec/Desktop/Coursera/tidyDataMeans.txt")){
                write.table(tidyDataMeans, file = "C:/Users/sec/Desktop/Coursera/tidyDataMeans.txt", row.names = FALSE)
        }
}